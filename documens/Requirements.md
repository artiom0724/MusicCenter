...
1. Польвателю будет предоставлена возможность авторизации.
2. Незарегистрированому польвателю будет предоставлена возможность регистрации.
...
3. Выбор жанра, заполнение полей "Artist", "Album" будет возможность произвести поиск по соответствующим категориям.

3.1.5 Редактирование профиля:
1. Пользователь может изменить свой пароль.
2.Сохраниение песен в "Favorites" или в "Listened" пользоветель будет пеенаправлен на страницу плейера, где соответствующая песня будет иметь возможность проиграть.
